...
class StoreMitraJobVacancyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'job_type' => ['required', 'string', Rule::in(array_keys(JobVacancy::jobTypeLabels()))],
            'work_policy' => ['required', 'string', Rule::in(array_keys(JobVacancy::workPolicyLabels()))],
            'experience_level' => ['required', 'string', Rule::in(array_keys(JobVacancy::experienceLabels()))],
