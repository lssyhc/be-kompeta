    ...
    public function rules(): array
    {
        ...
        if ($this->input('role') === User::ROLE_SEKOLAH) {
            return array_merge($rules, [
                ...
                'logo' => ['required', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
                'image_1' => ['nullable', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
                'image_2' => ['nullable', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
                'image_3' => ['nullable', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
                'image_4' => ['nullable', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
                'image_5' => ['nullable', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
        ...
        if ($this->input('role') === User::ROLE_MITRA && $this->input('mitra_type') === User::MITRA_PERUSAHAAN) {
            return array_merge($rules, [
                ...
                'socials.whatsapp' => ['nullable', 'string', 'max:30'],
                'short_description' => ['required', 'string', 'max:1000'],
                'company_logo' => ['required', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
                'image_1' => ['nullable', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
                'image_2' => ['nullable', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
                'image_3' => ['nullable', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
                'image_4' => ['nullable', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
        ...
        if ($this->input('role') === User::ROLE_MITRA && $this->input('mitra_type') === User::MITRA_UMKM) {
            return array_merge($rules, [
                ...
                'socials.whatsapp' => ['nullable', 'string', 'max:30'],
                'short_description' => ['required', 'string', 'max:1000'],
                'umkm_logo' => ['required', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
                'owner_ktp_photo' => ['required', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
                'image_1' => ['required', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
                'image_2' => ['required', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
                'image_3' => ['required', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
                'image_4' => ['required', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
                'image_5' => ['required', 'file', 'mimetypes:image/jpeg,image/png,image/webp', 'max:2048'],
            ]);
        }
